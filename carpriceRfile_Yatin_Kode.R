####################################################################################################################################
#Chinese car company Geely Auto price defination
#Author        : Yatin Kode
#Application Id: APFE18803934
...
#We dont see much abberations in the plot of actual price vs predicted price

#---------------------------------------------------------------------------------------------------------------------------------------
#	model	  	    |	Special function  |		Dropped variable/s			    |	r-squared	|	adjusted-r-squared	| (r-squared)-(adjusted rsquared) 
#---------------------------------------------------------------------------------------------------------------------------------------
#	model-1	      |	Applying Step AIC	|									              |	0.981 		|	0.9686				      |		0.0124				              |
#	model-2		    |						        |	wheelbase, carheight,         |	          |                     |                               |
#               |	                	|	boreratio,compressionratio,		|           |                     |                               |
#               |	                  |	 horsepower,mpg, symboling0,	|           |                     |                               |
#               |	                  |	 symboling2,companyaudi, 	    |           |                     |                               |
#               |	                  |	companychevrolet,companyisuzi	|	          |                     |                               |
#               |	                  |	,companyvolvo,fueltypegas,	  |           |                     |                               |
#               |	                  |	doornumbertwo,drivewheelfwd,	|	          |                     |                               |
#               |	                  |	enginetypel,enginetypeohcf,		|           |                     |                               |
#               |	                  |	enginetypel, companyporsche	  |           |                     |                               |
#               |	                  |	cylindernumberfour,		        |           |                     |                               |
#               |	                  |	cylindernumbersix,		        |           |                     |                               |
#               |	                  |	cylindernumberthree,		      |           |                     |                               |
#               |	                  |	cylindernumbertwelve,		      |           |                     |                               |
#               |	                  |	cylindernumbertwo,symboling.1	|           |                     |                               |
#               |	                  |	fuelsystem4bbl ,fuelsystemidi,|	          |                     |                               |
#               |	                  |	fuelsystemmpfi,fuelsystemspdi,|	          |                     |                               |
#               |	                  |	fuelsystemspfi,fuelsystem2bbl |	0.9794		|	0.9729				      |		0.0065                      |
#	model-3		    |						        |	carbodysedan					        | 0.9783 		|	0.9717				      |		0.0066                      |
#	model-4		    |						        |	wtbylen				                |	0.9765		|	0.9696				      |		0.0069                      |
#	model-5 	    |						        |	enginetypeohc  				      	|	0.9751		|	0.9682				      |		0.0069                      |
#	model-6 	    |						        |	enginetypeohcv					      |	0.9751		|	0.9684				      |		0.0067                      |
#	model-7 	    |						        |	symboling3        				    |	0.9749		|	0.9685				      |		0.0064                      |
#	model-8 	    |						        |	cylindernumberfive		        |	0.9741		|	0.9677				      |		0.0064                      |
#	model-9 	    |						        |	peakrpm   						        |	0.9716		|	0.965 				      |		0.0066                      |
#	model-10	    |						        |	drivewheelrwd 					      |	0.9697		|	0.9630				      |		0.0067                      |
#	model-11	    |						        |	companyhonda      		      	|	0.9689		|	0.9623			      	|		0.0066                      |
#	model-12	    |						        |	symboling1     					      |	0.9681		|	0.9616				      |		0.0065                      |
#	model-13	    |						        |	carbodyhatchback 				      |	0.9677		|	0.9615				      |		0.0062                      |
#	model-14	    |						        |	carbodyhardtop    			      |	0.9673		|	0.9613				      |		0.0060                      |
#	model-15	    |						        |	companysaab     				      |	0.9672		|	0.9615				      |		0.0057                      |
#	model-16	    |						        |	companyvolkswagen				      |	0.9659		|	0.9603				      |		0.0055                      |
#	model-17  	  |					        	|	companyrenault  				      |	0.9649		|	0.9594				      |		0.0050                      |
#	model-18	    |						        |	companynissan   				      |	0.9649		|	0.9594				      |		0.0055                      |
#	model-19	    |					        	|	carbodywagon					        |	0.9620		|	0.9569				      |		0.0051                      |
#	model-20	    |					        	|	companyplymouth					      |	0.9605	  |	0.9554				      |		0.0051                      |
#	model-21	    |						        |	companymazda					        |	0.9605		|	0.9554				      |		0.0051                      |
#	model-22	    |						        |	companypeugeot				        |	0.9535		|	0.9484				      |		0.0051                      |
#	model-23	    |						        |	companytoyota 					      |	0.9535		|	0.9484				      |		0.0051                      |
#	model-24	    |						        |	companydodge    			      	|	0.9575		|	0.9532			      	|		0.0043                      |
#	model-25	    |						        |	companymitsubishi			        |	0.9527		|	0.9487			      	|		0.004                       |
#|model-26      |                   | companymercury                | 0.9477    | 0.9437              |   0.004                       |
#               |                   |                               |           |                     |                               |
#######################################################################################################################################

#The difference between the R-squared and adjusted R-squared is 0.004~0 in the final model. so it is a good model
